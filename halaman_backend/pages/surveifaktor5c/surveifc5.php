...
$jaminanNasabah = mysqli_query($koneksi, "SELECT * from tb_hasil h LEFT JOIN tb_jaminan_nasabah jn ON h.id_jaminan_nasabah=jn.id_jaminan_nasabah ORDER BY jn.id_jaminan_nasabah DESC")->fetch_array();
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="?page=pages/surveifaktor5c/surveifc5">Data Survei <?= $arr[4]; ?></a></li>
