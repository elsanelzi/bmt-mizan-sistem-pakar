 ...
 <?php
    ...
    if (isset($_POST['simpan'])) {
        ...
        $status = "analisa pendapatan";
        $update = $koneksi->query("UPDATE tb_jaminan_nasabah SET status= '$status' WHERE id_pemberian_pembiayaan_nasabah='$id_pemberian_pembiayaan_nasabah'");
        if ($update) {
