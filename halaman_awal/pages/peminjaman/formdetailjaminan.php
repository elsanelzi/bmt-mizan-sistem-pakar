                 ...
                 <div class="col-lg-6 d-flex align-items-stretch">
                     ...
                     <?php
                        ...
                        if (isset($_POST['save'])) {
                            ...
                            $nama_foto_nomor_angka = $_FILES['foto_nomor_angka']['name'];
                            $lokasi_foto_nomor_angka = $_FILES['foto_nomor_angka']['tmp_name'];
                            ...
                            $nama_foto_nomor_mesin = $_FILES['foto_nomor_mesin']['name'];
                            $lokasi_foto_nomor_mesin = $_FILES['foto_nomor_mesin']['tmp_name'];
