                                ...
                                <?php foreach ($detailDataNasabah as $key => $value) : ?>
                                    ...
                                    <?php if ($value['jenis_jaminan'] == 'Sertifikat') : ?>
                                        ...
                                        <tr>
                                            ...
                                            <td width="10%">:</td>
                                            <td><img src="../assets/image/foto detail jaminan sertifikat nasabah/<?= $value['sertifikat_foto_tampak_kiri'] ?>" alt="" width="100px" height="100px"></td>
                                        </tr>
                                        <tr>
                                            <td width="30%">Foto Tampak Kanan</td>
                                            <td width="10%">:</td>
                                            <td><img src="../assets/image/foto detail jaminan sertifikat nasabah/<?= $value['sertifikat_foto_tampak_kanan'] ?>" alt="" width="100px" height="100px"></td>
                                        </tr>
