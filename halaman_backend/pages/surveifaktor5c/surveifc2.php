            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="?page=pages/surveifaktor5c/surveifc2">Data Survei <?= $arr[1]; ?></a></li>
                ...
                <div class="ml-10">
                    ...
                    <div class="tab-content">
                        ...
                        if (isset($_POST['save'])) {
                            ...
                            if ($edit) {
                                echo "<script>
                                                    window.location.href = '?page=pages/surveifaktor5c/surveifc3'</script>";
                            } else {
                                echo "<script>window.location.href = '?page=pages/surveifaktor5c/surveifc3'
                                                    </script>";
                            }
                        }
