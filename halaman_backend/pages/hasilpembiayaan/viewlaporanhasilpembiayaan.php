...
<div class="content-wrapper">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="?page=pages/hasilpembiayaan/viewlaporanhasilpembiayaan">Laporan Hasil Pembiayaan</a></li>
    ...
    <script type="text/javascript">
        $(window).load(function() {
            $("#pilih_berdasarkan").change(function() {
                console.log($("#pilih_berdasarkan option:selected").val());
                // Per Tanggal
                if ($("#pilih_berdasarkan option:selected").val() == 'per_tanggal') {
                    $('#tanggal').prop('hidden', false);
                } else {
                    $('#bulan').prop('hidden', true);
                    $('#tahun').prop('hidden', true);
                    $('#jenis_pembiayaan').prop('hidden', true);
                }

                //  Per Bulan
                if ($("#pilih_berdasarkan option:selected").val() == 'per_bulan') {
                ...
                //  Per tahun
                if ($("#pilih_berdasarkan option:selected").val() == 'per_tahun') {
                ...
                //  Per tahun
                if ($("#pilih_berdasarkan option:selected").val() == 'per_jenis_pembiayaan') {
                    $('#jenis_pembiayaan').prop('hidden', false);
                } else {
                    $('#tanggal').prop('hidden', true);
                    $('#bulan').prop('hidden', true);
                    $('#tahun').prop('hidden', true);
    ...
    <section class="content">
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    <h3 style="padding:10px;margin-left:10px">Laporan Hasil Pembiayaan</h3>
                </div>
                <div class="card">
                    ...
                    <div class="card-header">
                        ...
                        <form action="" method="POST">
                            <div class="row float-center">
                                ...
                                <div class="col-md-4" id="tanggal" hidden>
                                    <input type="date" name="per_tanggal" id="per_tanggal" class="form-control">
                                </div>
                                <div class="col-md-4" id="bulan" hidden>
                                ...
                                <div class="col-md-4" id="tahun" hidden>
                                    <input type="text" name="per_tahun" id="per_tahun" value="<?= date('Y') ?>" class="form-control">
                                </div>
                                <div class="col-md-4" id="jenis_pembiayaan" hidden>
